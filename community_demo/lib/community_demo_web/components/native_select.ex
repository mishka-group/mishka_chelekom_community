defmodule CommunityDemoWeb.Components.NativeSelect do
  @moduledoc """
  The `CommunityDemoWeb.Components.NativeSelect` module provides a customizable native select component
