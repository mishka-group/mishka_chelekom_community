defmodule CommunityDemoWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `CommunityDemoWeb.Components.Carousel`
  project.
