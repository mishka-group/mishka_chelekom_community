defmodule CommunityDemoWeb.Components.Image do
  @moduledoc """
  The `CommunityDemoWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
