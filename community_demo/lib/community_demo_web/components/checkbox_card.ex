defmodule CommunityDemoWeb.Components.CheckboxCard do
  @moduledoc """
  The `CommunityDemoWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
