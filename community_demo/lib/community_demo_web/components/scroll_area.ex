defmodule CommunityDemoWeb.Components.ScrollArea do
  @moduledoc """
  The `CommunityDemoWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
