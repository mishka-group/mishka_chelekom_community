defmodule CommunityDemoWeb.Components.Skeleton do
  @moduledoc """
  The `CommunityDemoWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
