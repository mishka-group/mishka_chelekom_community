defmodule CommunityDemoWeb.Components.RadioCard do
  @moduledoc """
  The `CommunityDemoWeb.Components.RadioCard` module provides a customizable radio card component for Phoenix LiveView
  ...
  defp color_variant("bordered", "info") do
    [
      ...
      "dark:checked:[&_.radio-card-input]:text-info--bordered-text-dark",
