defmodule CommunityDemoWeb.Components.Rating do
  @moduledoc """
  The `CommunityDemoWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
