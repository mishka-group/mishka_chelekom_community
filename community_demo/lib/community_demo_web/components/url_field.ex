defmodule CommunityDemoWeb.Components.UrlField do
  @moduledoc """
  CommunityDemoWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
