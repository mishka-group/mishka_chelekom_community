defmodule CommunityDemoWeb.Components.Alert do
  @moduledoc """
  CommunityDemoWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
