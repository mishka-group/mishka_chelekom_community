defmodule CommunityDemoWeb.Components.Gallery do
  @moduledoc """
  The `CommunityDemoWeb.Components.Gallery` module provides a customizable gallery component for displaying
