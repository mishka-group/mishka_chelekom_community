defmodule CommunityDemoWeb.Components.Footer do
  @moduledoc """
  The `CommunityDemoWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
