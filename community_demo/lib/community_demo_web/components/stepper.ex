defmodule CommunityDemoWeb.Components.Stepper do
  @moduledoc """
  The `CommunityDemoWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  def stepper_section(assigns) do
    ...
    >
      ...
      <span class={[
        "stepper-content block text-nowrap"
      ]}>
        <span :if={@title} class="block font-bold">
          {@title}
        </span>
