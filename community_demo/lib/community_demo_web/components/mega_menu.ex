defmodule CommunityDemoWeb.Components.MegaMenu do
  @moduledoc """
  The `CommunityDemoWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
