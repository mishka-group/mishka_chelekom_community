defmodule CommunityDemoWeb.Components.Clipboard do
  @moduledoc """
  The `CommunityDemoWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
