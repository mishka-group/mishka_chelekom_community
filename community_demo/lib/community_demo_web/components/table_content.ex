defmodule CommunityDemoWeb.Components.TableContent do
  @moduledoc """
  `CommunityDemoWeb.Components.TableContent` is a component module designed to create flexible and dynamic
