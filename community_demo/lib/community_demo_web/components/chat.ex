defmodule CommunityDemoWeb.Components.Chat do
  @moduledoc """
  `CommunityDemoWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
