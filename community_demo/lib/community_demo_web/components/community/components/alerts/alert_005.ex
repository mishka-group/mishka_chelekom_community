defmodule CommunityDemoWeb.Community.Components.Alerts.Alert005 do
  ...
  def community_alert_005(assigns) do
    ~H"""
    <.alert id={@id} variant="bg-[#DAF8E6] border-[#22AD5C]" border="border-s-[5px]" class={@class} icon={nil} rounded="large" padding="medium">
    <div class="flex gap-5">
      ...
      <div>
        <div :if={@title} class="text-[22px] leading-6 mb-5 text-[#004434] font-semibold">{@title}</div>
