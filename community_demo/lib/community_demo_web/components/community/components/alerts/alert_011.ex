defmodule CommunityDemoWeb.Community.Components.Alerts.Alert011 do
  ...
  def community_alert_011(assigns) do
    ~H"""
    <.alert id={@id} variant="bg-[#E9F9FF] border-[#0B76B7]" border="border-s-[5px]" class={@class} icon={nil} rounded="large" padding="medium">
    <div class="flex gap-5">
      <div class="size-8 shrink-0 bg-[#0B76B7] text-white rounded flex items-center justify-center">
      ...
      <div>
        <div :if={@title} class="text-[22px] leading-6 mb-3 text-[#0B76B7] font-semibold">{@title}</div>
