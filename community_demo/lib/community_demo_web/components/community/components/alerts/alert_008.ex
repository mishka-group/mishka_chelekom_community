defmodule CommunityDemoWeb.Community.Components.Alerts.Alert008 do
  ...
  def community_alert_008(assigns) do
    ~H"""
    <.alert id={@id} variant="bg-[#FEF3F3] border-[#F23030] shadow-md" border="border-s-[5px]" class={@class} icon={nil} rounded="large" padding="medium">
    <div class="flex gap-5">
      ...
      <div>
        <div :if={@title} class="text-[22px] leading-6 mb-5 text-[#BC1C21] font-semibold">{@title}</div>
