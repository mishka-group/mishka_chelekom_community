defmodule CommunityDemoWeb.Components.DeviceMockup do
  @moduledoc """
  The `CommunityDemoWeb.Components.DeviceMockup` module provides a customizable component for displaying
