defmodule CommunityDemoWeb.Components.Tabs do
  @moduledoc """
  `CommunityDemoWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  def tabs(%{vertical: true} = assigns) do
    ...
    <div
      ...
      class={[
        ...
        @variant == "default" || (@variant == "base" && tab_border(@tab_border, @vertical)),
  ...
  defp color_variant("base", "base") do
    [
      "[&_.tab-trigger.active-tab]:bg-[#F8F9FA] [&_.tab-trigger.active-tab]:text-[#09090b]",
      "[&_.tab-trigger.active-tab]:border-[#F8F9FA]",
      "hover:[&_.tab-trigger]:text-[#09090b] hover:[&_.tab-trigger]:border-[#F8F9FA]",
      "dark:[&_.tab-trigger.active-tab]:bg-[#242424] dark:[&_.tab-trigger.active-tab]:text-[#FAFAFA]",
      "dark:[&_.tab-trigger.active-tab]:border-[#242424] ",
      "dark:hover:[&_.tab-trigger]:text-[#FAFAFA] dark:hover:[&_.tab-trigger]:border-[#242424]",
      "hover:[&_.tab-trigger]:bg-[#F8F9FA] dark:hover:[&_.tab-trigger]:bg-[#242424]"
    ]
  end
